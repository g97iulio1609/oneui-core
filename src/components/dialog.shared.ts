 ...
 * Note: Consumer should call handleOpen when dialog opens to reset value.
 */
export function useDialogInput(
  ...
  // Reset input callback - consumer should call this when dialog opens
  ...
  }, [defaultValue, onControlledChange]);

  return { value, setValue, handleOpen };
}
